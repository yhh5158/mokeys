...
public class PlatformConfig {
    ...
    static {
        ...
        configs.put(PlatformType.PASTE, new PlatformConfig.Paste(PlatformType.PASTE));
    }
    ...
    //paste
    public static class Paste implements PlatformConfig.Platform {
        private final PlatformType media;
        ...
        public Paste(PlatformType type) {
            this.media = type;
        }
    }

    public static void setPaste(String appKey) {
        PlatformConfig.Paste mPaste = (PlatformConfig.Paste)configs.get(PlatformType.PASTE);
    }
