package com.room.mokeys.maps.utils;
...
//    }
    ...
    private static SharedPreferences sPref = App.getContext().getSharedPreferences(App.getContext().getPackageName() + "_preferences", Context.MODE_PRIVATE);
