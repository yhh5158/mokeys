...
public class AdManager {
    ...
    private AnimDialogUtils.OnLoginClickListenner mLoginClick;
    /**
     * 广告弹窗距离两侧的距离-单位(dp)
     */
    ...
    public void setOnLoginClickLinstener(AnimDialogUtils.OnLoginClickListenner click){
        this.mLoginClick = click;
    }
    /**
     * 开始执行显示广告弹窗的操作
     * @param animType
    ...
    public void showAdDialog(final int animType) {
        ...
        animDialogUtils.setOnLoginClickLinstener(mLoginClick);
    ...
    public void showAdDialog(final int animType,boolean login) {
